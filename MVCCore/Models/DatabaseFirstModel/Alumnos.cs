...
namespace MVCCore.DatabaseFirstModel
{
    public partial class Alumnos
    {
        ...
        [Required(ErrorMessage = "El campo {0} no puede estar vacio."), Range(13, 99, ErrorMessage = "El campo {0} debe estar comprendido entre {1} a {2}.")]
        public byte Edad { get; set; }
        [DisplayName("DNI"), Required(ErrorMessage = "El campo {0} no puede estar vacio."), Range(11111111, 99999999, ErrorMessage = "El DNI debe estar comprendido entre {1} a {2}.")]
