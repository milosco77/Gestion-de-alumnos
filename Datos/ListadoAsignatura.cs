...
#nullable disable
        ...
        {
            return db.ListadoAsignaturas.OrderBy(la => la.ListadoAsignaturasId).ToList();
        }
...
#nullable enable
        public static string Eliminar(int? listadoAsignaturasID = null, string? codigo = null, string? nombre = null, int? creditos = null, int? horas = null, string? correlativas = null, string? categoria = null, int? listadoCarrerasID = null)
        {
            ...
            {
                return $"El elemento del ListadoAsignaturas no ha sido eliminado debido a excepcion: {e.Message} que indica que no se encontro el elemento para poder eliminarlo.";
            }
            catch (Exception e)
            {
                return $"El elemento del ListadoAsignaturas no ha sido eliminado debido a excepcion: {e}";
            }
        }
#nullable disable
    }
